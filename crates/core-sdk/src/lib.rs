...
pub use node_registry::{
    ...
    NODE_REGISTRY_CONSENSUS_PUBKEY_BYTES, NODE_REGISTRY_CONSENSUS_SIGNATURE_BYTES,
    NODE_REGISTRY_OPERATOR_SEAL_EK_BYTES, SERVES_ARCHIVE, SERVES_BRIDGE_RELAY, SERVES_BROADCASTER,
    SERVES_GPU_PROVE, SERVES_INDEXER, SERVES_LIGHT_CLIENT, SERVES_ORACLE_WRITER, SERVES_PUBLIC_API,
    SERVES_RPC, SERVES_WEBSOCKET,
};
