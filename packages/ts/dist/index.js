...
function deriveClobMarketId(baseTokenId, quoteTokenId) {
  ...
  return bytesToHex4(keccak_256(concatBytes3(new Uint8Array([CLOB_MARKET_ID_DOMAIN_TAG]), base, quote)));
}
