...
type DecodeTxResponse = {
     ...
     * emitted by the node under the `roundAttestation` key.
     */
...
interface ValidateAddressOptions {
    /**
 ...
 */
declare function validateAddress(address: string, opts?: ValidateAddressOptions): AddressValidation;
...
type NoEvmReceiptTrustIssueCode = "missing_receipt_proof" | "missing_archive_proof" | "archive_policy_not_valid_at_height" | "archive_verification_failed";
...
declare const CLAIMED_EVENT_SIG: "Claimed(address,uint256,bool)";
...
declare const CLAIMED_EVENT_TOPIC0: "0xfa8256f7c08bb01a03ea96f8b3a904a4450311c9725d1c52cdbe21ed3dc42dcc";
 ...
 * topic/data slicing.
 */
declare function decodeClaimedEvent(topics: readonly (string | Uint8Array | readonly number[])[], data: string | Uint8Array | readonly number[]): ClaimedEvent;
...
declare const WALLET_AUTH_CHALLENGE_VERSION: "1";
declare const WALLET_AUTH_ALGORITHM: "ml-dsa-65";
declare const WALLET_AUTH_SIGNING_PREFIX: "monolythium.wallet-auth.v1\0";
declare const WALLET_AUTH_NONCE_BYTES: 32;
declare const WALLET_AUTH_MAX_SCOPES: 16;
declare const WALLET_AUTH_MAX_SCOPE_BYTES: 128;
declare const WALLET_AUTH_MAX_TTL_SECONDS: 180;
declare const WALLET_AUTH_MAX_CLOCK_SKEW_SECONDS: 30;
declare const WALLET_AUTH_MAX_DOMAIN_BYTES: 512;
declare const WALLET_AUTH_MAX_ORIGIN_BYTES: 528;
declare const WALLET_AUTH_MAX_URI_BYTES: 529;
declare const WALLET_AUTH_MAX_ADDRESS_BYTES: 128;
declare const WALLET_AUTH_MAX_CHALLENGE_JSON_BYTES: 8192;
declare const WALLET_AUTH_MAX_PROOF_JSON_BYTES: 24576;
type WalletAuthErrorCode = "invalid_object" | "invalid_field" | "non_canonical" | "not_yet_valid" | "expired" | "address_mismatch" | "invalid_public_key" | "signature_invalid";
...
interface WalletAuthChallengeV1 {
 ...
 */
declare function parseWalletAuthChallengeV1(value: unknown): WalletAuthChallengeV1;
/**
 * Strict canonicalization boundary. V1 intentionally rejects instead of
 * rewriting non-canonical authority-bearing fields.
 */
declare function canonicalizeWalletAuthChallengeV1(value: unknown): WalletAuthChallengeV1;
/** Canonical no-whitespace JSON, encoded in the audit-locked field order. */
declare function canonicalWalletAuthChallengeJsonV1(value: unknown): string;
/** Canonical JSON bytes (without the signing prefix). */
declare function encodeWalletAuthChallengeV1(value: unknown): Uint8Array;
/** Reject JSON that is valid structurally but not already byte-canonical. */
declare function decodeWalletAuthChallengeV1(encoded: Uint8Array | string): WalletAuthChallengeV1;
/** Prefix + canonical JSON: the exact application-level signing preimage. */
declare function walletAuthChallengeSigningPreimageV1(value: unknown): Uint8Array;
/** Keccak-256 digest signed as the ML-DSA-65 prehash message. */
declare function walletAuthChallengeDigestV1(value: unknown): Uint8Array;
/** Encode 32 random bytes as the challenge's canonical base64url nonce. */
declare function encodeWalletAuthNonceV1(bytes: Uint8Array): string;
/** Build and sign a proof with an existing wallet ML-DSA-65 backend. */
declare function createWalletAuthProofV1(challengeValue: unknown, backend: Pick<MlDsa65Backend, "publicKey" | "signPrehash">): WalletAuthProofV1;
/** Strictly validate and clone a proof-shaped object without verifying it. */
declare function parseWalletAuthProofV1(value: unknown): WalletAuthProofV1;
/** Canonical no-whitespace proof JSON, including the nested canonical challenge. */
declare function canonicalWalletAuthProofJsonV1(value: unknown): string;
declare function encodeWalletAuthProofV1(value: unknown): Uint8Array;
declare function decodeWalletAuthProofV1(encoded: Uint8Array | string): WalletAuthProofV1;
/**
